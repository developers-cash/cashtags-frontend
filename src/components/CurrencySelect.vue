  ...
  methods: {
    filterCurrencies (val, update, abort) {
      update(() => {
        ...
        this.currencyOptions = this.currencies.filter(v => v.toLocaleLowerCase().indexOf(needle) > -1)
      })
    },
